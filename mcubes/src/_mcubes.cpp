...
static const char __pyx_k_mcubes[] = "_mcubes";
...
static int __pyx_pymod_exec__mcubes(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "_mcubes")) {
      if (unlikely(PyDict_SetItemString(modules, "_mcubes", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _mcubes", 0, __pyx_lineno, __pyx_filename);
    }
